...
function addDependenciesEsm() {
	return gulp.src('./node_modules/html-factory/dist/browser/esm/*{.debug,.min}.js{,.map}')
...
function addDependenciesEs6() {
	return gulp.src('./node_modules/html-factory/dist/browser/es6/*{.debug,.min}.js{,.map}')
...
function addDependenciesEs5() {
	return gulp.src('./node_modules/html-factory/dist/browser/es5/*{.debug,.min}.js{,.map}')
...
const addDependencies = gulp.parallel(
	addDependenciesEsm,
	addDependenciesEs6,
	addDependenciesEs5
);
...
module.exports = {
	build: gulp.series(cleanup, addDependencies, build),
	watch: gulp.series(cleanup, addDependencies, build, watch)
};
