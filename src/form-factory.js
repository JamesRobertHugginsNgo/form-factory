/* @if TARGET="NODE" && DEBUG */
const { renderElement } = require('html-factory/dist/node/html-factory.js');
/* @endif */
/* @if TARGET="NODE" && !DEBUG **
const { renderElement } = require('html-factory/dist/node/html-factory.debug.js');
/* @endif */
/* @if TARGET="BROWSER_ESM" && DEBUG **
import { renderElement } from './html-factory.debug.js';
/* @endif */
/* @if TARGET="BROWSER_ESM" && !DEBUG **
import { renderElement } from './html-factory.min.js';
/* @endif */
